...
class StudentExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('guardian_status'),
            ExportColumn::make('guardian_nik'),
            ExportColumn::make('guardian_name'),
            ExportColumn::make('guardian_city_born'),
            ExportColumn::make('guardian_birthday'),
            ExportColumn::make('guardian_religion'),
            ExportColumn::make('guardian_education'),
